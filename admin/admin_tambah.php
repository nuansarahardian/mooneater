					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
									<div class="panel-heading">Form Tambah Pegawai</div>
								<div class="panel-body">
									<form method="post" name="theform" action="admin_add.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
