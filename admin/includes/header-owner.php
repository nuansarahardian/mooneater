<div class="brand clearfix">
	...
	<a href="../index.php" style="font-size: 20px;"><img src="img/mooneater.png" width="250px" height="60px"></a>  
		...
		<ul class="ts-profile-nav col-md-2">
            <?php
			...
			<li class="ts-account">
				...
				<ul>
					<li><a href="change-password-admin.php"><i class="fa fa-key pull-right"></i>Ganti Password</a></li>
					<li><a href="profile-owner.php"><i class="fa fa-user pull-right"></i>Profil</a></li>
