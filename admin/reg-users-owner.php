									...
									?>	
										<tr>
											...
											<!-- <td align='center'>
												...
												<td>	<a href="hapus_member.php?id_user=<?php echo $result['id_user'];?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $result['id_user'];?>?');"><i class="fa fa-trash"></i></a></td>
											</td> -->
										</tr>
										<?php } ?>
