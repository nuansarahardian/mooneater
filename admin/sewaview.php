...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Tanggal Take</b></td>
		<td width="2%"><b>:</b></td>
	...
	<!-- <tr>
		<td width="20%"><b>Unggah Foto</b></td>
		<td width="2%"><b>:</b></td>
		<td>
		<?php 
					if($result['stt_trx']=="Sudah Dibayar"||$result['stt_trx']=="Selesai"){
					?>
					<a href="tambah_foto.php?id_trx=<?=$result['id_trx']?>" class="btn btn-warning btn" style="font-family:Poppins; font-weight:bold; color:white; font-size: 15px;">Unggah Foto</a>
