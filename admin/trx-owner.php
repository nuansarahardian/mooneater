								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%" >
									...
									<?php
										...
										<tr align="center">
											...
											<td><?php echo htmlentities($result['id_galery']);?></td>
											<!-- <td>
										...
										<td>	<a href="trx_bayar_hapus_trx.php?id=<?php echo $result['id_trx'];?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $result['id_trx'];?>?');"><i class="fa fa-trash"></i></a></td> -->
										</tr>
										<?php }?>
									</tbody>
								</table>
