...
<head>
	...
	<link href="img/moonfav.png" rel="icon" type="images/x-icon">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Moon Eater Std </h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : mooneater@gmail.com</td>
					</tr>
					<tr>
						<td class="text-center">Purbalingga</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
