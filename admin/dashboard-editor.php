			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title" style="font-family:Poppins; font-weight:bold; color:black; font-size: 30px;">Dashboard - Editor
						</h2>
							...
							<div class="col-md-12">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="jadwal-editor.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
