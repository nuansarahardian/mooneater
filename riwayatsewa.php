	...
	if(mysqli_num_rows($query1)!=0){
		...
		?>
			<tr>
				...
				<td align="center">
				<?php 
					if($result['stt_trx']=="Selesai"){
					?>
					<a href="download_foto.php?id_trx=<?php echo $result['id_trx'];?>" class="btn btn-warning btn-xs">Download Foto</a>
				
				
					<!-- <?php 
						if($result['ubah_tgl']==1){
					?>
					...
					?>
					<?php 
					if($result['stt_trx']=="Sudah Dibayar"){

						echo "Menunggu Jadwal Pemotretan";
				
					?>
						<?php 
						}if($result['stt_trx']=="Menunggu Konfirmasi"){
