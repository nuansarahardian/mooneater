        ...
        <div class="row mt-5 justify-content-center">
          ...
          <div class="row">
            ...
            <div class="col-2 mb-3">
              <img width="200px" src="upload/<?= $row["nama_file"];?>" alt="">
              <div class="mt-2 mb-2 text-center">
                ...
                <a href="upload/<?= $row["nama_file"];?>" download><button class="btn btn-sm btn-outline-success">Download</button></a>
              </div>
            </div>
              <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-fullscreen">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="upload/<?= $row["nama_file"];?>" download><button class="btn btn-success">Download</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
