...
{
?>
 <h3>Ada Pertanyaan? Silahkan Hubungi kami di </h3>
          <ul >
         
            <li>
           
              <div class="icon_wrap"><i class="fa fa-map-marker" aria-hidden=""></i></div>
              <div class="contact_info_m"><?php   echo htmlentities($result['alamat_kami']); ?></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div  class="contact_info_m"><a href="https://wa.link/fqmav1"><?php   echo htmlentities($result['telp_kami']); ?></a></div>
            </li>
            <li>
