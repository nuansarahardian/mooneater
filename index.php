    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <!-- <li role="presentation" class="active"><a href="gallery.php" role="tab" data-toggle="tab"></a></li> -->
          <a href="gallery.php" class="btn">Gallery <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </ul>
      ...
      <div class="recent-tab">
<!-- 
      <img src="image/1.jpg" class="galeri">
      <img src="image/2.jpg" class="galeri">
      <img src="image/3.jpg" class="galeri">
      <img src="image/4.jpg" class="galeri"> -->
</div>
